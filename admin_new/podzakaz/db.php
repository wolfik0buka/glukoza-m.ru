...
switch ($_POST['doIt']) {
    ...
    case ('get_tovar_list_json'):
        ...
        break;
    case ('saveTovar'):
        $stmt = $mysqli->prepare('update tovar
                                         set tovar.name = ?,
                                             tovar.desc_full = ?,
                                             tovar.description = ?,
                                             tovar.price = ?,
                                             tovar.price_old = ?
                                      where tovar.id = ?');
        $stmt->bind_param('sssddi', $_POST['name'],
            $_POST['desc_full'],
            $_POST['description'],
            $_POST['price'],
            $_POST['price_old'],
        ...
        break;
    case ('addTovar'):
        $stmt = $mysqli->prepare('insert into tovar (tovar.name, tovar.desc_full, tovar.description, tovar.price, tovar.price_old)
                                      values (?,?,?,?,?)');
        $stmt->bind_param('sssdd', $_POST['name'],
            $_POST['desc_full'],
            $_POST['description'],
            $_POST['price'],
            $_POST['price_old']);
