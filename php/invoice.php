...
class cash_memo
{
    ...
    public $cour_id = '';  // Номер заявки в системе курьеров
                               ...
                               <body>
                                   ...
                                   <table>
                                       <tr>
                                           ...
                                           <td class="invoice_stor">ООО "Сингер-Мед", ИНН 7814557450, КПП 781401001, 197372, Санкт-Петербург г, Камышовая, дом № 38, корпус 1, кв.54, тел.: +7 (812) 244-4192</td>
                                       </tr>
                                       <tr>
...
while ($row = $res->fetch_object()) {
    ...
    $bonus = $row->bonus;
    if ($row->cour_id != '') $html->cour_id = '<div class="cour_id">' . $row->cour_id . '</div>';
}
$html->cnt = $cnt - 1;
...
if ($bonus != 0) $html->podval .= '<tr><td style="text-align: right;">Скидка по бонусной программе: </td><td style="width: 100px; text-align: right;">' . number_format($bonus, 2, ',', ' ') . '</td></tr>';
$html->podval .= '<tr><td style="text-align: right;">Без налога (НДС) </td><td style="width: 100px; text-align: right;">-</td></tr>
                     <tr><td style="text-align: right;">Всего к оплате: </td><td style="width: 100px; text-align: right;">' . number_format(($sum_all - $bonus), 2, ',', ' ') . '</td></tr>
                 </table>';
