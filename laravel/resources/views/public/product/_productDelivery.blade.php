<div class="top-40">
    ...
    <table class="deliveryTable">
        <tr>
            <td>
                Cамовывоз из магазина Глюкоза (м. Озерки)
                <div class="text-muted font-s13">Улица Сикейроса, дом 10, корпус 4, литера А, ТК «Бульвар», секция 4/2</div>
            </td>
        ...
        <tr>
            <td>
                ...
                <div class="text-muted font-s13">Доставим {{ \Carbon\Carbon::now()->format("Hi") < '1729' ? 'сегодня' : 'завтра' }}</div>
            </td>
            <td>от 300 руб.</td>
        </tr>
    </table>
